...
function populateListProductChoices() {
    ...
    var optionArray = restrictListProducts(products, nuts, lactose, organic);

	// for each item in the array, create a checkbox element, each containing information such as:
	// <input type="checkbox" name="product" value="Bread">
	// <label for="Bread">Bread/label><br>
	optionArray = optionArray.sort((a,b) => {return a.price-b.price;});
...
function init(){
	var s2 = document.getElementById('displayProduct');
    s2.innerHTML = "";
	var optionArray = restrictListProducts(products, false, false, false);
	optionArray = optionArray.sort((a,b) => {return a.price-b.price;});
	for (i = 0; i < optionArray.length; i++) {
